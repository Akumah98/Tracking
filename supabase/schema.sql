...
CREATE TABLE IF NOT EXISTS "Shipment" (
  ...
  "originCity" TEXT NOT NULL, "originCountry" TEXT NOT NULL,
  "originLat" DOUBLE PRECISION NOT NULL, "originLng" DOUBLE PRECISION NOT NULL,
  "destCity" TEXT NOT NULL, "destCountry" TEXT NOT NULL,
  "destLat" DOUBLE PRECISION NOT NULL, "destLng" DOUBLE PRECISION NOT NULL,
  "currentCity" TEXT NOT NULL, "currentCountry" TEXT NOT NULL,
  "currentLat" DOUBLE PRECISION NOT NULL, "currentLng" DOUBLE PRECISION NOT NULL,
  "estimatedDelivery" TIMESTAMP WITH TIME ZONE,
  "eddConfidence" INTEGER NOT NULL DEFAULT 95,
  "weight" TEXT, "dimensions" TEXT, "sku" TEXT,
  "sourceProvider" TEXT NOT NULL DEFAULT 'itl_control_tower',
  "shipperName" TEXT, "shipperEmail" TEXT, "shipperPhone" TEXT, "shipperAddress" TEXT, "shipperCity" TEXT,
  "receiverName" TEXT, "receiverEmail" TEXT, "receiverPhone" TEXT, "receiverAddress" TEXT, "receiverCity" TEXT,
  "product" TEXT, "contents" TEXT, "carrier" TEXT, "shipmentType" TEXT, "shipmentMode" TEXT,
  "carrierReferenceNumber" TEXT, "paymentMode" TEXT, "freightCost" DOUBLE PRECISION,
  "departureDate" TIMESTAMP WITH TIME ZONE, "pickupDate" TEXT, "pickupTime" TEXT,
  "totalActualWeight" DOUBLE PRECISION, "totalVolumetricWeight" DOUBLE PRECISION, "totalVolume" DOUBLE PRECISION,
...
CREATE TABLE IF NOT EXISTS "PackagePiece" (
  ...
  "quantity" INTEGER NOT NULL DEFAULT 1, "pieceType" TEXT NOT NULL DEFAULT 'Box',
  "description" TEXT, "length" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "width" DOUBLE PRECISION NOT NULL DEFAULT 0, "height" DOUBLE PRECISION NOT NULL DEFAULT 0,
  "weight" DOUBLE PRECISION DEFAULT 0, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT NOW()
);
...
CREATE TABLE IF NOT EXISTS "Milestone" (
  ...
  "status" TEXT NOT NULL, "location" TEXT NOT NULL, "description" TEXT NOT NULL
);

CREATE TABLE IF NOT EXISTS "AdminOverride" (
  "id" TEXT PRIMARY KEY DEFAULT gen_random_uuid()::text,
  "shipmentId" TEXT NOT NULL REFERENCES "Shipment"("id") ON DELETE CASCADE,
  "field" TEXT NOT NULL, "oldValue" TEXT, "newValue" TEXT NOT NULL, "reason" TEXT,
  "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT NOW()
);

CREATE TABLE IF NOT EXISTS "ProviderHealthLog" (
  "id" TEXT PRIMARY KEY DEFAULT gen_random_uuid()::text,
  "provider" TEXT NOT NULL, "status" TEXT NOT NULL, "latencyMs" INTEGER NOT NULL,
  "message" TEXT, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT NOW()
);
